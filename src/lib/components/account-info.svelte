...
<Namor text={account} let:result>
    <div class="content mt-2 flex items-center px-3 md:hidden">
        ...
        <span class="ml-3 text-xs opacity-50 md:block">{formatMoney(worth)} USD</span>
    </div>
    <div class="nav sticky top-14 z-30 bg-base-100 px-3 md:pt-3">
        <div class="content flex flex-wrap items-center justify-between bg-base-100">
            <div class="flex items-center">
                <h3 class="relative m-0 text-lg font-bold md:text-2xl">{result}</h3>
